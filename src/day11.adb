...
procedure Day11 is
    ...
    function Equilibrium_Occupancy(
        G : in Grid;
        Count_Neighbours : access function(G : in Grid; x,y : Positive) return Natural;
        tolerance : in Natural
    ) return Natural is
...
begin
    ...
    declare
        ...
        p1 : constant Natural := Equilibrium_Occupancy(G, Part_1'Access, 4);
        p2 : constant Natural := Equilibrium_Occupancy(G, Part_2'Access, 5);
    begin
